...
const BusAssistantAccidentsReportsMenuItem = () => {
    const { user } = useAuth()
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        if (!assignedNumberPlate) {
            setErrorMessage('No number plate is assigned to this bus assistant account.')
            return
        }
...
export default BusAssistantAccidentsReportsMenuItem
