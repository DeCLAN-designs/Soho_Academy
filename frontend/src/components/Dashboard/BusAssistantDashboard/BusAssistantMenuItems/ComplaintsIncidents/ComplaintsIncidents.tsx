...
import './ComplaintsIncidents.css'
...
const BusAssistantComplaintsIncidentsMenuItem = () => {
    ...
    const selectedAttachmentLabel = useMemo(() => {
        ...
        return `${attachmentFile.name} â¢ ${formatFileSize(attachmentFile.size)}`
    }, [attachmentFile])
            ...
            {activeView === 'report' ? (
                <>
                    <div className="driverMenuCompliantsReports__header">
                        <div>
                            <h3 className="driverMenuCompliantsReports__title">Complaints & Incidents</h3>
...
export default BusAssistantComplaintsIncidentsMenuItem
