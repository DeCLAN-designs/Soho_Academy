  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        includeAssets: ['favicon.ico', 'logo.png', 'pwa-icon.svg'],
        manifest: {
          name: 'Soho Transport Management',
          short_name: 'Soho Transport',
          description: 'Transport management system for schools',
          theme_color: '#670122',
